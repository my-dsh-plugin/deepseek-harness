...
export const en = {
  ...
  modelReasoningEfforts: 'Thinking levels',
  modelReasoningEffortsHint: 'Select the levels this model offers — the selection dialog shows exactly these. A blank spelling on off sends nothing; a blank non-off spelling falls back to the level name.',
  reasoningWireSpelling: 'Wire spelling',
  reasoningWireOff: 'blank = send nothing',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelReasoningEfforts: '思考等级',
  modelReasoningEffortsHint: '勾选该模型可提供的思考等级，模型选择器只显示这些选项。off 的拼写留空表示发送空值；其他等级留空则回退为等级名。',
  reasoningWireSpelling: 'Wire 拼写',
  reasoningWireOff: '留空 = 发送空值',
  fetchModels: '获取可用模型',
  fetching: '正在询问提供方\u2026',
